(function () {
    ...
    callWithJQuery(function ($) {
        ...
        pivotTableRenderer = function (pivotData, opts) {
            ...
            result = document.createElement("table");// ZEMMOURI : HTML 5 Table
            result.appendChild(document.createElement("thead"));// ZEMMOURI : HTML 5 Table Head
            result.appendChild(document.createElement("tbody"));// ZEMMOURI : HTML 5 Table Body
            result.appendChild(document.createElement("tfoot"));// ZEMMOURI : HTML 5 Table Foot
            result.id = "pvtTable";
            ...
            for (j in colAttrs) {
                ...
                result.tHead.appendChild(tr);// ZEMMOURI : HTML 5 Table Head row
            }
            ...
            for (i in rowKeys) {
                ...
                for (j in rowKey) {
                    ...
                    if (x !== -1) {
                        th = document.createElement("td");// ZEMMOURI : HTML 5 Table Head element
                ...
                tr.appendChild(td);
                result.tBodies[0].appendChild(tr);// ZEMMOURI : HTML 5 Table Body row
            }
            tr = document.createElement("tr");
            th = document.createElement("th");
            th.className = "pvtTotalLabel";
            ...
            td.setAttribute("data-value", val);
            tr.appendChild(td);
            result.tFoot.appendChild(tr);// ZEMMOURI : HTML 5 Table Foot row
            result.setAttribute("data-numrows", rowKeys.length);
            result.setAttribute("data-numcols", colKeys.length);
            result.setAttribute("data-toggle", "table"); // ZEMMOURI : to use by table-bootstrap
            return result;
        };
